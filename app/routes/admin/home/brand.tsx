        ...
        <>
            ...
            <div className="grow bg-[#1b2028] my-2 rounded-md p-4 w-full">
                ...
                <div className="overflow-x-hidden no-scrollbar">
                    ...
                    {
                        brand.map((val: any, index: number) => {
                            return (
                                <div key={index} className="bg-[#31353f] hover:bg-slate-800 rounded-md flex px-4 py-2 my-2 text-white font-medium text-md flex-nowrap">
                                    ...
                                    <div className="grow"></div>
                                    <div className="w-24">
                                        {Number(val.brandStatus) ? <div className="w-16 py-1 text-white text-xs bg-green-500 text-center rounded-md font-medium">ACTIVE</div> : <div className="w-16 py-1 text-white text-xs bg-rose-500 text-center rounded-md font-medium">INACTIVE</div>}
                                    </div>
                                    <div className="grow"></div>
