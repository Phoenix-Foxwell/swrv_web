            ...
            {isbrand ?
                ...
                <>
                    ...
                    < div >
                        <div className="flex my-6 md:flex-row flex-col">
                            <div>
                                <h1 className="text-2xl font-bold text-black text-left mt-4">Find {searchBrand ? "brand" : "campaign"}</h1>
                                <p className="text-md font-normal text-black text-left">Here you can search manage all the {searchBrand ? "brand" : "campaign"} that you are participating in.</p>
                            </div>
            ...
            <div className="bg-white rounded-2xl my-6 shadow-xl p-4">
                ...
                <div className="grid place-items-center lg:place-items-start grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    {props.data.map((val: any, index: number) => {
                        ...
                        return (
                            <div key={index}>
                                <InfluencerCard id={val["id"]} image={avatar} name={name} star={3}  ></InfluencerCard>
                            </div>
                        );
                    })}
