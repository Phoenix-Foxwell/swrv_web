      ...
      <div className="grow bg-[#eeeeee] my-2 rounded-md p-4 w-full">
              ...
              return (
                ...
                >
                  <div className="flex gap-4 w-full">
                    ...
                    />
                    <div>
                      <div className="text-xl text-black">{val.platformName}</div>
                      <div className="text-md text-black">{val.handleName}</div>
                    </div>
                    <div className="grow"></div>
                  </div>
                  <div
        ...
        {platformData == null || platformData == undefined ? (
          <p className="my-2 py-1 px-2 rounded-md border border-rose-400 bg-rose-500 bg-opacity-10 text-rose-500 cursor-pointer text-center text-sm">
            Kindly select a channel to display the insights
          </p>
        ) : (
