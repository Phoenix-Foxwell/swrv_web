...
var UsersPage = (props) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full px-6 sm:px-16", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full md:w-3/5 lg:w-4/6 mx-auto mb-10  py-8", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid xl:grid-cols-3 grid-cols-1 lg:grid-cols-2 justify-center place-items-center gap-y-4", children: props.userdata.map((val, index) => {
        let image = val.pic == null || val.pic == void 0 || val.pic == "" || val.pic == "0" ? "/images/avatar/user.png" : val.pic;
        return index < 6 ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full h-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(UserCard, { name: val.userName.toString().split("@")[0], description: val.bio, imageUrl: image }, void 0, false, {
          fileName: "app/components/users/users.tsx",
          lineNumber: 31,
          columnNumber: 45
        }, this) }, index, false, {
...
var UserCard = (props) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: `w-64 text-left shadow-xl rounded-xl pb-4 m-4 h-full`, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: props.imageUrl, alt: "err", className: "w-full h-56 object-cover object-top rounded-t-md" }, void 0, false, {
      fileName: "app/components/users/users.tsx",
      lineNumber: 55,
      columnNumber: 17
    }, this),
...
//# sourceMappingURL=/build/_shared/chunk-7EZZKFIU.js.map
