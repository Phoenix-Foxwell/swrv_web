...
var Apply = (props) => {
  ...
  const [error2, setError2] = (0, import_react.useState)(null);
  ...
  const applyChampaign = async () => {
    ...
    if (((_a = messageRef.current) == null ? void 0 : _a.value) == null || ((_b = messageRef.current) == null ? void 0 : _b.value) == void 0 || ((_c = messageRef.current) == null ? void 0 : _c.value) == "")
      return setError2("Message can't be blank");
    let req = {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-6 bg-white rounded-xl shadow-xl w-96", children: [
          ...
          error2 == "" || error2 == null || error2 == void 0 ? null : /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-red-500 bg-opacity-10 border-2 text-center border-red-500 rounded-md text-red-500 text-md font-normal text-md my-4", children: error2 }, void 0, false, {
            fileName: "app/routes/home/campaigns.$id.tsx",
            lineNumber: 790,
            columnNumber: 13
          }, this),
...
var ChampaingAcceptRequest = (props) => {
  ...
  const [acceptbox2, setAcceptbox2] = (0, import_react.useState)(false);
  const [rejectbox2, setrejectbox2] = (0, import_react.useState)(false);
  const [error2, setError2] = (0, import_react.useState)(null);
  const rejectiontextRef = (0, import_react.useRef)(null);
  const [id2, setId2] = (0, import_react.useState)(null);
  const init = async () => {
    let req = {
      search: {
        status: "1",
  ...
  const rejectRequest = async () => {
    ...
    if (((_a = rejectiontextRef.current) == null ? void 0 : _a.value) == null || ((_b = rejectiontextRef.current) == null ? void 0 : _b.value) == void 0 || ((_c = rejectiontextRef.current) == null ? void 0 : _c.value) == "")
      return setError2("Fell the reason.");
    let req = {
      id: id2,
      status: "5",
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      "div",
      {
        className: `fixed top-0 left-0  h-screen w-full bg-slate-900 bg-opacity-10 place-items-center ${acceptbox2 ? "grid" : "hidden"}`,
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      "div",
      {
        className: `fixed top-0 left-0  h-screen w-full bg-slate-900 bg-opacity-10 place-items-center ${rejectbox2 ? "grid" : "hidden"}`,
        children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white w-72 shadow-lg p-4 rounded-lg", children: [
        ...
        "input",
        {
          ...
          onChange: (value) => {
            ...
            if (file_size < 4) {
              ...
              setError2("Pdf file size must be less then 4 mb");
            }
          }
        },
        void 0,
        ...
        "button",
        {
          onClick: async () => {
            ...
            if (platform == null || platform == void 0 || platform == 0 || platform == "") {
              setError2("Select the platform.");
            } else if (pdfFile == null || pdfFile == void 0) {
              setError2("Select the pdf file.");
              ...
              setError2("Write the description.");
            } else {
              ...
              if (pdfurl.status) {
                ...
                if (data.data.status == false) {
                  return setError2(data.data.message);
                } else {
                  window.location.reload();
                }
              } else {
                setError2(pdfurl.data);
              }
            }
...
var LinkCampaign = (props) => {
  ...
  const [errors, setError2] = (0, import_react.useState)([]);
  ...
  const init = async () => {
    ...
    setError2(Array(responseData.data.data.length).fill(""));
...
var Bidding = (props) => {
  const [error2, setError2] = (0, import_react.useState)("");
  ...
  const submit = async () => {
    ...
    if (bidamount == void 0 || bidamount == null) {
      setError2("Fill the Bid amount.");
    } else if (Number(bidamount) % 100 !== 0) {
      setError2("Bid amount must be a multiple of 100.");
    } else if (amount < Number(bidamount)) {
      setError2("Bid amount must be less then current bid amount.");
...
var ChampaingBidRequest = (props) => {
  ...
  const init = async () => {
    ...
    if (responseData.data.status) {
      ...
      setError2(responseData.data.message);
    }
  };
  (0, import_react.useEffect)(() => {
    init();
...
//# sourceMappingURL=/build/routes/home/campaigns.$id-2PBEPFSL.js.map
