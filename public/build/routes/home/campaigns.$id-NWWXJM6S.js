...
var ChampaingAcceptRequest = (props) => {
  ...
  const [acceptbox, setAcceptbox2] = (0, import_react.useState)(false);
  const [rejectbox, setrejectbox2] = (0, import_react.useState)(false);
  const [error, setError] = (0, import_react.useState)(null);
  const rejectiontextRef = (0, import_react.useRef)(null);
  const [id, setId2] = (0, import_react.useState)(null);
  const init = async () => {
    let req = {
      search: {
        status: "1",
...
//# sourceMappingURL=/build/routes/home/campaigns.$id-NWWXJM6S.js.map
