                ...
                if (platform == null || platform.length == 0 || platform == void 0) {
                  ...
                  if (campaginType == "6") {
                    ...
                    const req = {
                      ...
                      minReach: "0",
                      maxReach: "0",
                      costPerPost: (_x = CostPerPost.current) == null ? void 0 : _x.value,
                      totalBudget: "0",
                      dos: "0",
                      donts: "0",
                      mentions: "0",
                      hashtags: "0",
                      campaignTypeId,
                      campaignName: (_y = CampaignName.current) == null ? void 0 : _y.value,
                      campaignInfo: (_z = campinfo.current) == null ? void 0 : _z.value,
                      platforms: platform.join(),
                    ...
                    if (data2.data.status == false) {
                      ...
                      await axios_default({
                        ...
                        data: {
                          title: "New Campaign Created",
                          body: (_A = CampaignName.current) == null ? void 0 : _A.value,
                          to: "/topics/influencer"
                        }
                      });
                      return navigator(
...
//# sourceMappingURL=/build/routes/home/createcampaign/spbd-73FLUHOR.js.map
