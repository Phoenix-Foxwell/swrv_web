...
import {
  require_jsx_runtime
} from "/build/_shared/chunk-C3FEWCCA.js";
import {
  CusButton
...
// node_modules/.pnpm/@react-google-maps+api@2.18.1_react-dom@18.2.0_react@18.2.0/node_modules/@react-google-maps/api/dist/esm.js
...
function InfoWindowFunctional({ children, anchor, options, position, zIndex, onCloseClick, onDomReady, onContentChanged, onPositionChanged, onZindexChanged, onLoad, onUnmount }) {
  ...
  (0, import_react.useEffect)(() => {
    const infoWindow2 = new google.maps.InfoWindow(Object.assign({}, options || {}));
    setInstance(infoWindow2);
    containerElementRef.current = document.createElement("div");
    if (onCloseClick) {
      setCloseClickListener(google.maps.event.addListener(infoWindow2, "closeclick", onCloseClick));
    }
    if (onDomReady) {
      setDomReadyClickListener(google.maps.event.addListener(infoWindow2, "domready", onDomReady));
    }
    if (onContentChanged) {
      setContentChangedClickListener(google.maps.event.addListener(infoWindow2, "content_changed", onContentChanged));
    }
    if (onPositionChanged) {
      setPositionChangedClickListener(google.maps.event.addListener(infoWindow2, "position_changed", onPositionChanged));
    }
    if (onZindexChanged) {
      setZindexChangedClickListener(google.maps.event.addListener(infoWindow2, "zindex_changed", onZindexChanged));
    }
    infoWindow2.setContent(containerElementRef.current);
    if (position) {
      infoWindow2.setPosition(position);
    }
    if (zIndex) {
      infoWindow2.setZIndex(zIndex);
    }
    if (anchor) {
      infoWindow2.open(map, anchor);
    } else if (infoWindow2.getPosition()) {
...
var InfoWindow = class extends import_react.PureComponent {
  constructor() {
    ...
    this.open = (infoWindow2, anchor) => {
      if (anchor) {
        infoWindow2.open(this.context, anchor);
      } else if (infoWindow2.getPosition()) {
        infoWindow2.open(this.context);
      } else {
        invariant_1(false, `You must provide either an anchor (typically render it inside a <Marker>) or a position props for <InfoWindow>.`);
      }
    };
  ...
  componentDidMount() {
    const infoWindow2 = new google.maps.InfoWindow(Object.assign({}, this.props.options || {}));
    this.containerElement = document.createElement("div");
    this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
var Step3 = () => {
  ...
  const audienceText = (0, import_react3.useRef)(null);
  const [auderror, setAudError] = (0, import_react3.useState)(null);
  const [addaudience, setAddAudience] = (0, import_react3.useState)(false);
  ...
  const datepicker = (0, import_react3.useRef)(null);
  ...
  const [latlong, setLatlong] = (0, import_react3.useState)({ lat: 28.7041, long: 77.1025 });
  (0, import_react3.useEffect)(() => {
    ...
    if (((_d = Radius.current) == null ? void 0 : _d.value) != null) {
  ...
  const Radius = (0, import_react3.useRef)(null);
  const radius = createcampaign_default((state) => state.radius);
  const setRadius = createcampaign_default((state) => state.setRadius);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white shadow-xl rounded-xl px-8 py-4 mt-4", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "text-black tect-xl font-medium text-left", children: "Audience & Demography" }, void 0, false, {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
            "option",
            {
              ...
              disabled: true,
              children: "Select the Influencer category"
            },
            void 0,
            false,
            {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-4 w-full grid place-items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "py-1 px-4 rounded-md bg-green-500 text-white font-semibold text-lg", onClick: getCurrentLocation, children: "Get Current Location" }, void 0, false, {
      fileName: "app/routes/home/createcampaign/step3.tsx",
      lineNumber: 339,
      columnNumber: 62
    }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "text-primary tect-xl font-medium text-left my-1", children: "Maximum radius of the campaign [in KM.]" }, void 0, false, {
      fileName: "app/routes/home/createcampaign/step3.tsx",
      lineNumber: 340,
      columnNumber: 9
    }, this),
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
            "option",
            {
              ...
              className: "border-none outline-none font-normal text-lg",
              disabled: true,
              children: "Select a remuneration option"
            },
            void 0,
            false,
            {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
        "div",
        {
          ...
          onClick: () => {
            ...
            } else if (((_d = Radius.current) == null ? void 0 : _d.value) == null || Radius.current.value == void 0 || ((_e = Radius.current) == null ? void 0 : _e.value) == "" || parseInt((_f = Radius.current) == null ? void 0 : _f.value) == 0) {
              setError("Select maximum radius of the influencer.");
            } else if (((_g = datepicker.current) == null ? void 0 : _g.value) == null || ((_h = datepicker.current) == null ? void 0 : _h.value) == void 0 || ((_i = datepicker.current) == null ? void 0 : _i.value) == "") {
              setError("Select Accept participation last date. ");
            } else if (((_j = remuneration.current) == null ? void 0 : _j.value) == null || ((_k = remuneration.current) == null ? void 0 : _k.value) == void 0 || ((_l = remuneration.current) == null ? void 0 : _l.value) == "") {
              setError("Select remuneration. ");
            } else {
              setTillDate((_m = datepicker.current) == null ? void 0 : _m.value);
              setMaxInf(parseInt((_n = maxInf.current) == null ? void 0 : _n.value));
              setRemuneration((_o = remuneration.current) == null ? void 0 : _o.value);
              setRadius(parseInt((_p = Radius.current) == null ? void 0 : _p.value));
              navigator2("/home/createcampaign/step4");
            }
          },
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
            CusButton,
...
//# sourceMappingURL=/build/routes/home/createcampaign/step3-CVWTVQLU.js.map
