...
var location_default = useGeoLocation;
...
var Step3 = () => {
  ...
  const audienceText = (0, import_react4.useRef)(null);
  const [auderror, setAudError] = (0, import_react4.useState)(null);
  const [addaudience, setAddAudience] = (0, import_react4.useState)(false);
  ...
  const datepicker = (0, import_react4.useRef)(null);
  ...
  const [latlong, setLatlong] = (0, import_react4.useState)({ lat: 28.7041, long: 77.1025 });
  ...
  const Radius = (0, import_react4.useRef)(null);
  ...
  const getCurrentLocation = () => {
    ...
    if (location.coordinates.lat == null || location.coordinates.lat == void 0) {
      setError("Kindly Give permission to browswer for location");
      return;
    }
    setMarker({
...
//# sourceMappingURL=/build/routes/home/createcampaign/step3-HHSW5YXE.js.map
