...
var Sorry = () => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-[#eeeeee] min-h-screen p-6 grid place-items-center w-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full bg-white rounded-lg shadow-lg p-10 mt-6 relative ", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex gap-4 w-full justify-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "text-white text-xl bg-primary rounded-md py-1 px-2", children: "Resent MAIL" }, void 0, false, {
        fileName: "app/routes/sorry.tsx",
        lineNumber: 22,
        columnNumber: 25
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/contact", className: "text-white text-xl bg-primary rounded-md py-1 px-2", children: "Contact Us" }, void 0, false, {
        fileName: "app/routes/sorry.tsx",
        lineNumber: 23,
        columnNumber: 25
      }, this)
...
//# sourceMappingURL=/build/routes/sorry-ILVFQODU.js.map
